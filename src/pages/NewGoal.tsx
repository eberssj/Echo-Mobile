...
import { View, Text, TextInput, TouchableOpacity, StyleSheet } from 'react-native'; // Removido SafeAreaView
...
const NewGoal: React.FC<NewGoalProps> = ({ setUser }) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <BottomNavbar /> {/* Movido para fora do SafeAreaView */}
    </View>
  );
};
...
const styles = StyleSheet.create({
  container: {
    flex: 1,
    backgroundColor: '#fff',
    paddingBottom: 60, // Adicionado para evitar sobreposição com BottomNavbar
  },
  content: {
    flex: 1,
    padding: 20,
